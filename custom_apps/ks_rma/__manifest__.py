...
Expedite the process of merchandise replace/return process and faster resolution of refund process with the 
    ...
    'data': [
        ...
        'security/ks_rma_security_groups.xml',
        'report/ks_report.xml',
        'report/ks_report_rma.xml',
        'data/ks_rma_sequence.xml',
        'data/ks_rma_email_template.xml',
        'report/ks_rma_report_views.xml',
        'views/ks_res_config_settings_views.xml',
        'views/ks_stock.xml',
        'views/ks_rma_views.xml',
        'views/ks_rma_menus.xml',
        'views/ks_rma_portal.xml',
        'views/ks_sale_order_rma.xml',
        'views/ks_rma_reasons.xml',
        'views/ks_assets.xml'
    ],
    'installable': True,
    'auto_install': False
