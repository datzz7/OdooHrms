...
class Channel(models.Model):
    ...
    def init_odoobot(self):
        if self.env.user.odoobot_state in [False, 'not_initialized']:
            ...
            message = _("Hello,<br/>BriQ's chat helps employees collaborate efficiently. I'm here to help you discover its features.<br/><b>Try to send me an emoji</b> <span class=\"o_odoobot_command\">:)</span>")
