...
#         new_company = self.env['ir.config_parameter'].get_debranding_parameters().get('briqx_debranding.new_name')
#         planner_footer = self.env['ir.config_parameter'].get_debranding_parameters().get('briqx_debranding.planner_footer')
