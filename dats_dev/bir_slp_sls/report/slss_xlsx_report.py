...
class SummaryListSales(models.AbstractModel):
    _name = 'report.briqx_vat_relief.summary_list_sales'
    _inherit = 'report.report_xlsx.abstract'

    def generate_xlsx_report(self, workbook, data, obj):
        sheet = workbook.add_worksheet('BIR SLS')
        ...
        for rec in obj:
                tin = rec.client_tin if rec.client_tin else ''
                ...
                sheet.write(row, col+13, rec.output_vat),
